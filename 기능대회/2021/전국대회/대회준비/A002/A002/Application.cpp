...
INT WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, INT) {
	...
	WNDCLASSEX wcx = {
		...
		sizeof(WNDCLASSEX), CS_CLASSDC, MsgProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, L"A002", NULL
	};
	RegisterClassEx(&wcx);

	g_hWnd = CreateWindow(L"A002", L"A002", WS_OVERLAPPEDWINDOW, 100, 100, 1024, 768, GetDesktopWindow(), NULL, wcx.hInstance, NULL);
	...
	UnregisterClass(L"A002", wcx.hInstance);
	return 0;
}