...
CGameScene::CGameScene() {
	...
	_map = new CMap(_g_Asset.Map0, D3DXVECTOR2(0, 0));
	_ui = new CUI(&_g_Asset.CUI);
	_player = new CPlayer(&_playerBullets);
	_boss1 = new CBoss(0, D3DXVECTOR2(384, -50), &_enemyBullets);
	_bomb = new CBomb();
	...
	_enemySpawn[0] = CEnemySpawn(3, 0, D3DXVECTOR2(384, -100), 0);
	_enemySpawn[1] = CEnemySpawn(3.5, 0, D3DXVECTOR2(184, -100), 0);
	_enemySpawn[2] = CEnemySpawn(3.5, 0, D3DXVECTOR2(584, -100), 0);
	_enemySpawn[3] = CEnemySpawn(5, 1, D3DXVECTOR2(584, -100), 1);
	_enemySpawn[4] = CEnemySpawn(5, 1, D3DXVECTOR2(184, -100), 1);
	_enemySpawn[5] = CEnemySpawn(9, 2, D3DXVECTOR2(0, 150), 0);
	_enemySpawn[6] = CEnemySpawn(9, 3, D3DXVECTOR2(768, 150), 0);
	_enemySpawn[7] = CEnemySpawn(9.5, 2, D3DXVECTOR2(0, 150), 0);
	_enemySpawn[8] = CEnemySpawn(9.5, 3, D3DXVECTOR2(768, 150), 0);
	_enemySpawn[9] = CEnemySpawn(10, 2, D3DXVECTOR2(0, 150), 0);
	_enemySpawn[10] = CEnemySpawn(10, 3, D3DXVECTOR2(768, 150), 0);
	_enemySpawn[11] = CEnemySpawn(12, 0, D3DXVECTOR2(184, -100), 0);
	_enemySpawn[12] = CEnemySpawn(12, 0, D3DXVECTOR2(584, -100), 0);
	_enemySpawn[13] = CEnemySpawn(12.5, 1, D3DXVECTOR2(384, -100), 1);

	_enemySpawn[14] = CEnemySpawn(13.5, 2, D3DXVECTOR2(0, 100), 0);
	_enemySpawn[15] = CEnemySpawn(14, 2, D3DXVECTOR2(0, 150), 0);
	_enemySpawn[16] = CEnemySpawn(14.5, 2, D3DXVECTOR2(0, 200), 0);
	_enemySpawn[17] = CEnemySpawn(15, 2, D3DXVECTOR2(0, 250), 0);
	_enemySpawn[18] = CEnemySpawn(15.5, 2, D3DXVECTOR2(0, 300), 0);

	_enemySpawn[19] = CEnemySpawn(17, 3, D3DXVECTOR2(768, 100), 0);
	_enemySpawn[20] = CEnemySpawn(17.5, 3, D3DXVECTOR2(768, 150), 0);
	_enemySpawn[21] = CEnemySpawn(18, 3, D3DXVECTOR2(768, 200), 0);
	_enemySpawn[22] = CEnemySpawn(18.5, 3, D3DXVECTOR2(768, 250), 0);
	_enemySpawn[23] = CEnemySpawn(19, 3, D3DXVECTOR2(768, 300), 0);

	_enemySpawn[24] = CEnemySpawn(20, 0, D3DXVECTOR2(384, -100), 0);
	_enemySpawn[25] = CEnemySpawn(22, 1, D3DXVECTOR2(384, -100), 1);
	_enemySpawn[26] = CEnemySpawn(23, 1, D3DXVECTOR2(584, -100), 1);
	_enemySpawn[27] = CEnemySpawn(23, 1, D3DXVECTOR2(184, -100), 1);

	_enemySpawn[28] = CEnemySpawn(25, 2, D3DXVECTOR2(0, 100), 0);
	_enemySpawn[29] = CEnemySpawn(25.5, 2, D3DXVECTOR2(0, 150), 0);
	_enemySpawn[30] = CEnemySpawn(26, 2, D3DXVECTOR2(0, 100), 0);
	_enemySpawn[31] = CEnemySpawn(26.5, 2, D3DXVECTOR2(0, 150), 0);
	_enemySpawn[32] = CEnemySpawn(27, 2, D3DXVECTOR2(0, 100), 0);

	_enemySpawn[33] = CEnemySpawn(26, 3, D3DXVECTOR2(768, 100), 0);
	_enemySpawn[34] = CEnemySpawn(26.5, 3, D3DXVECTOR2(768, 150), 0);
	_enemySpawn[35] = CEnemySpawn(27, 3, D3DXVECTOR2(768, 100), 0);
	_enemySpawn[36] = CEnemySpawn(27.5, 3, D3DXVECTOR2(768, 150), 0);
	_enemySpawn[37] = CEnemySpawn(28, 3, D3DXVECTOR2(768, 100), 0);
...
void CGameScene::Update(float deltaTime) {
	...
	if (isBossDead) {
		...
		if (_finTimer >= _finTime) {
			...
			_finTimer = 0;
			_g_Black.LoadScene(new CNextScene());
		}
	}
	...
	if (GetAsyncKeyState(VK_UP)) {
		...
		isPush = true;
		_player->Move(0, ((-600) + (300 * _player->isSlow)) * deltaTime);
	}
	...
	if (GetAsyncKeyState(VK_LEFT)) {
		...
		isPush = true;
		_player->Move(((-600) + (300 * _player->isSlow)) * deltaTime, 0);
	}
