...
CSecondScene::CSecondScene() {
	...
	_subBoss = new CBoss(&_enemyBullets, &_enemyMissiles, 2);
	_Boss = new CBoss(&_enemyBullets, &_enemyMissiles, 3);
...
void CSecondScene::MsgProc(UINT uMsg, WPARAM wParam, LPARAM lParam) {
